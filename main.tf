...
resource "aws_lb_listener_rule" "main" {
  ...
  condition {
    host_header {
      values = [var.component == "frontend" ? "${var.env}.maheshkoheda5.online" : "${var.component}-${var.env}.maheshkoheda5.online"]
    }
  }
}
...
resource "aws_lb_listener_rule" "public" {
  ...
  condition {
    host_header {
      values = ["${var.env}.maheshkoheda5.online" ]
    }
  }
}
...
resource "aws_iam_policy" "main" {
    ...
    "Statement": [
  {
    ...
    "Resource": "arn:aws:ssm:us-east-1:541801958935:parameter/docdb.${var.env}.*"
  },
  {
    "Sid": "VisualEditor1",
    "Effect": "Allow",
